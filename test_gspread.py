...
# Simulez les secrets (copiés depuis votre secrets.toml)
secrets = {
    "gcp_service_account": {
...
tIqho4F0ZKdmtL3GT9YwHrePZi89gnf2idWWFZSCe/z++4Ca1GBN37Qe7acow16f
...
5rwaNXvRZHoEs2xKE9dJ5tnD9wKBgQDpA4a9S6KOA8RQCxkGNmw48xxhEWDkgGs1
...
nnmpsL0bg0y25B3K9+AKmiAg4nQhn3o69btQIZFI6Y6+16Ulj4UIPcwp2/VuICKle
...
try:
    ...
    print("Connexion réussie ! Données :", rows)
