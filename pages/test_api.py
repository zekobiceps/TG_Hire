...
def get_gsheet_client():
    """
    Crée un fichier JSON temporaire à partir de st.secrets après avoir corrigé 
    la clé privée pour contourner les erreurs de formatage Streamlit Cloud.
    """
    ...
    try:
        # 1. Crée une copie modifiable du secret (pour contourner l'erreur 'TypeError: Secrets does not support item assignment')
